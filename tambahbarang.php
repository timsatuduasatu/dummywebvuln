  ...
  <section class="home-section">
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard">Tambah Inventory</span>
      </div>      
    </nav>
            ...
            <form method="post" action="simpanbarang.php" enctype="multipart/form-data" onsubmit="return detectsqlinjection()">
                ...
                <div class="sales-details">                 
                    ...
                    <div class="status-radio">
                      <input type="radio" name="tipe" id="tipe" value="hardfile"> Hardfile
                      <input type="radio" name="tipe" id="tipe" value="softfile" style="margin-left: 20px;"> Softfile
                    </div>  
                <div class="sales-details">                 
